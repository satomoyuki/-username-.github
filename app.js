...
window.onload = function() {
    ...
    if (name) {
        const results = [
            { outcome: "P 賞", color: "#FFD700", gif: "daikichi.gif" },
            { outcome: "O 賞", color: "#C0C0C0", gif: "chukichi.gif" },
            { outcome: "L 賞", color: "#CD7F32", gif: "shokichi.gif" },
            { outcome: "K 賞", color: "#FF4500", gif: "suekichi.gif" },
